...
public class PostProccesingController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tankAI = GameObject.Find("Aras' Tank").GetComponent<AIAras>();       
    }

    // Update is called once per frame
    void Update()
    {
        p_chromaticAberation.intensity.value = (tankAI.speed/1.25f);
    }
}
